...
\node[] at (-1.2,-1) {$\times$};
\draw[fill=gray!20,  fill opacity=90]  (-1.2,-0.5) ellipse (2 and 1);
...
\draw[draw=blue, fill=blue!20, fill opacity=20]  (-1.2,-0.4) node (v1) {} ellipse (1.2 and 0.4);

\fill[fill=blue!20, fill opacity=20] (-2.4,-0.4) .. controls (-2.4,-0.2) and (-1.6,1) .. (-1.2,1) .. controls (-0.8,1) and (0,-0.2) .. (0,-0.4) .. controls (0,-0.2) and (-0.8,-0.2) .. (-1.2,-0.2) .. controls (-1.6,-0.2) and (-2.4,-0.2) .. (-2.4,-0.4);
