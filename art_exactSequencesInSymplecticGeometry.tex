...
\begin{itemize}
    ...
    \item Finally, we will look at several examples (\snip{Lagrangian surgery}{art:LagrangianSurger},\snip{Dehn twists}{art:dehnTwist} and \snip{Lagrangian cobordisms}{art:lagrangianCobordisms}) where exact triangles arise in symplectic geometry.
\end{itemize}
